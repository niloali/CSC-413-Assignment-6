...
public class CustomerList extends javax.swing.JFrame {
    ...
    private void detailsActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_detailsActionPerformed
        BankCustomer selectedCustomer = (BankCustomer) custList.getSelectedValue();
        if (selectedCustomer != null) {
            int customerId = selectedCustomer.getCustomerNumber();
            // Use the customer ID to fetch customer details and populate the customer detail window
    ...
    public void updateCustomerList(List<BankCustomer> customers) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerList.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
