...
public class CustomerSearch extends javax.swing.JFrame {
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(84, 84, 84)
                                                .addComponent(city, javax.swing.GroupLayout.PREFERRED_SIZE, 128,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_searchActionPerformed
        if (evt.getSource() == search) {
            ...
            if (!cty.isEmpty()) {
                try {
                    List<BankCustomer> customers = CustomerDTO.findCustomer(cty);
                    if (customers.isEmpty()) {
                        JOptionPane.showMessageDialog(this, "No customers found in the city: " + cty, "No Customers",
                                JOptionPane.WARNING_MESSAGE);
                    } else {
                        CustomerList customerListFrame = new CustomerList();
                        customerListFrame.updateCustomerList(customers);
                    ...
                    JOptionPane.showMessageDialog(this,
                            "Error occurred while searching for customers: " + ex.getMessage(),
                            "Error", JOptionPane.ERROR_MESSAGE);
                }
            } else {
                JOptionPane.showMessageDialog(this, "Please enter a city name.", "Empty City",
                        JOptionPane.WARNING_MESSAGE);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerSearch.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
