...
public class BankAccountTransactionDTO {
    ...
    static BankAccountTransactionDAO ato = new BankAccountTransactionDAO();
    ...
    public static List<BankAccountTransaction> findTransactions(String accountId) throws SQLException {
        return ato.searchByAccountId(accountId);
    }
}
